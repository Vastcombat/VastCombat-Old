function vastcombat(arg1, arg2) {
  if (arg1 == "onPageLoad") {
    ...
    document.getElementById("lobby-homepage").innerHTML = arg2;
...
if (localStorage) { hasLocalStorageSupport = true; } else { hasLocalStorageSupport = false; }